...
- **Core links (virtual):** C1↔C2 **ports 47 and 49** — straight aqua LC–LC x-rays; 47 raised / 49 lowered by one line thickness. Controls → **Core** show/hide. LEDs green on 47 & 49.
...
|----------------|-------------|
| (this) | Virtual C1↔C2 ports 47+49 aqua lines, vertically spaced by line thickness |
